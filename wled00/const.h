...
#define DEFAULT_AP_SSID     "DDprint-AP"
#define DEFAULT_AP_PASS     "ddprint123"
#define DEFAULT_OTA_PASS    "ddprintota"
#define DEFAULT_MDNS_NAME   "ddprint"
